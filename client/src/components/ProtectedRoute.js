      ...
      <div className="flex gap-2 w-full h-full h-100">
        ...
        <div className="body">
          <div className="header flex justify-between">
            ...
            <h1 className="text-2xl text-white">Chameli Devi Group of Institutions</h1>
            <div>
              <div className="flex gap-1 items-center">
                <h1 className="text-md text-white">{user?.name}</h1>
              </div>
              <span>Role : {user?.role === "admin" ? "Admin" : user?.role === "teacher" ? "Faculty" : "Student"}</span>
            </div>
          </div>
